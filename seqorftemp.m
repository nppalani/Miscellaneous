function orfOutput = seqshoworfs(seq,varargin)
...
%   SEQSHOWWORDS, SEQSTATSDEMO, SEQVIEWER, SEQWORDCOUNT.
...
noDisplay = true; % default value is false
transFlag = false;% default value is false
gcode = 1;
...
if ~noDisplay
    ...
    [~, viewC] = javacomponent(scrollpanel, ...
